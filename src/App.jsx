...
color:C.mut,flexShrink:0}}>Precio actual · {symbol}</span>
<a href={yahooUrl} target=”_blank” rel=“noreferrer”
style={{fontFamily:bold,fontSize:”.78rem”,fontWeight:700,color:C.accent,
textDecoration:“none”,padding:“4px 12px”,border:“1px solid “+C.accent+“44”,
background:C.accent+“10”,borderRadius:2,letterSpacing:”.04em”}}>
Ver en Yahoo Finance →
</a>
<span style={{fontSize:”.5rem”,color:C.mut}}>Precio en tiempo real en el enlace</span>
</div>
);
}
...
<style>{`@keyframes blink{0%,100%{opacity:1}50%{opacity:.3}} @keyframes prg{0%{width:0%;margin-left:0}50%{width:65%;margin-left:0}100%{width:0%;margin-left:100%}}`}</style>
